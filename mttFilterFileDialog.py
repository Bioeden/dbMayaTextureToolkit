...
# PySide import
from PySide.QtCore import Qt, Signal, QRect, QSize, QDir
from PySide.QtGui import (
    QListView, QListWidget, QItemSelectionModel, QListWidgetItem, QDialog,
    QCursor, QVBoxLayout, QFileSystemModel, QAbstractItemView, QHBoxLayout,
    QPushButton, QIcon, QLineEdit, QFrame, QComboBox, QCompleter,
    QStringListModel, QFileDialog)
# Maya import
